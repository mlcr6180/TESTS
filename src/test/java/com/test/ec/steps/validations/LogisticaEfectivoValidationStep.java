...
import com.test.ec.pages.validations.LogisticaEfectivoValidationPage;
import net.serenitybdd.annotations.Step;

public class LogisticaEfectivoValidationStep extends LogisticaEfectivoValidationPage {
